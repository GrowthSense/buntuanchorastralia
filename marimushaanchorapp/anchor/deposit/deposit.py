        ...
        **kwargs: Dict
        ...
        return {
            "how": (
                ...
                "Accounting Number: 036176797405 ; Routing Number: 628524560. "
                "Users MUST include the following memo: "
                f"{memo_for_transaction(transaction)}"
            ),
            "extra_info": {
                "accounting_number": "036176797405",
                "routing_number": "628524560",
                "memo": f"{memo_for_transaction(transaction)}",
            }
        }